# Project-203: Jenkins Pipeline for Dockerized Phonebook Application (Python Flask & MySQL) Deployed on Docker Swarm
...
```text
203-jenkins-pipeline-for-phonebook-app-on-docker-swarm (folder)
|
